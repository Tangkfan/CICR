...
from dataset import TACoSDataset, QVHighlightsDataset, AnetCDDataset
...
from model import CICR, HungarianMatcher, Criterion
...
def build_CLIP_text_encoder(CLIP_text_encoder_path):
    import clip
    # pretrained_model, _ = clip.load(CLIP_text_encoder_path)
