...
from utils.func_utils import mkdirp, load_json, save_json, make_zipfile, dict_to_markdown
...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--config_file", type=str, default='config/tacos/C3D_GloVe_evalquyi.json')
        
        ## dataset
        parser.add_argument("--dataset_name", type=str, default=None, choices=['charades', 'charades-cg', 'charades-cd', 'qvhighlights', 'tacos'])
        ...
        parser.add_argument("--ci_detr", type=dict, default=None)
        ...
        if isinstance(self, TestOptions):
            ...
            if opt.trained_result_dir is None:
                ...
                if opt.dataset_name == "qvhighlights":
                    ...
                    split_name = "test"
                if opt.dataset_name == "charades-cd":
                    opt.resume = os.path.join(opt.trained_result_dir, f"model_{split_name}_ood_best.ckpt")
                else:
